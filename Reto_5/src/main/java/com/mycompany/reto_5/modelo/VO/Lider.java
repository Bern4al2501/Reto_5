 ...
 */
package com.mycompany.reto_5.modelo.VO;
//Con DAO hacemos la conexion a bases de datos con VO hacemos la clase de la tabla de la que vamos a sacar la informacion
 ...
 */
public class Lider {
    //Le vamos a dar los atributos de la consulta a la clase
